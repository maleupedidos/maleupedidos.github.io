...
(async () => {
  ...
  try {
    ...
    /* EL BOTÓN ACTUALIZAR. Qué pide y qué dice cuando algo falla se mide en
       `probar_objetivo_sello.js`, que para eso puede romper cada fuente por
       separado. Acá quedó sólo que el botón termine: esta prueba es la del fin
       de semana, y el ↻ entra nada más que como vecino.
       (Las dos comprobaciones que vivían acá —"declara volcado y planMes" y
       "pide planMes antes que admin"— se mudaron el 23/9/2026, cuando la tab
       dejó de pedir el volcado entero y pasó a pedir `pedidosLight`.) */
