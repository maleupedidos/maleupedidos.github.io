...
const PEDIDOS = [
  ...
  H({ c: 'Ana Prueba', tel: '1100000001', bar: 'Estancias del Pilar', fex: '2026-09-12', he: '19:20', $: 10000, co: 7000, p: [{ a: 'PPM', q: 1 }] }),
  ...
  P({ h: 'Pilar', es: 'Entregado', c: 'Fede Prueba', bar: 'Pilara', fex: '2026-09-09', dee: '2026-09-09', mc: '2026-09', $: 40000, co: 30000, p: [{ a: 'CLo', q: 0.75 }] }),
...
(async () => {
  ...
  try {
    ...
    const s53 = await ev(cli, `(function(){var R=_rsArmar('2026-12-28');return {semN:R.semN,cob:R.cob.tot,h:R.h};})()`);
    chk('semana 53 (28/12 a 3/1): el cobro del "02/01" sin año cae adentro', s53 && s53.semN === 53 && s53.cob === 7000 && s53.h === '2027-01-03', s53);
