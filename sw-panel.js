var CN='maleu-panel-v181';
self.addEventListener('install',function(e){e.waitUntil(caches.open(CN).then(function(c){return c.addAll(['/app.html','/panel-manifest.json','/img/favicon.png']);}));self.skipWaiting();});
